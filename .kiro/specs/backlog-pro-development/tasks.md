...
- [ ] 5. Implementar módulo de autenticación (auth)
  - Crear servicio de integración con Supabase Auth
  - Implementar registro de usuario (signup)
  - Implementar inicio de sesión (signin)
...
- [ ] 6. Implementar módulo de usuarios (users)
- [ ] 6.1 Crear entidad de dominio User
...
- [ ] 6.5 Crear resolvers GraphQL de usuario
...
- [ ] 8. Implementar módulo de proyectos (projects)
- [ ] 8.1 Crear entidades de dominio Project y ProjectMember
...
- [ ] 8.2 Crear entidades TypeORM y mappers
...
- [ ] 8.3 Implementar CQRS para proyectos
...
- [ ] 15.1 Configurar Redis para caché
  - Instalar y configurar @nestjs/cache-manager y cache-manager-redis-store
  - Configurar TTL para métricas (ej: 30 segundos)
  - _Requisitos: 6.1, 6.2, 6.3_

- [ ] 15.2 Implementar cálculo de métricas de sprint
  - Query: CalcularMetricasSprintQuery + Handler
  - Calcular: velocidad, story points, tiempo de ciclo
  - Implementar caché con Redis
  - _Requisitos: 6.1_

- [ ] 15.3 Implementar cálculo de métricas de proyecto
  - Query: CalcularMetricasProyectoQuery + Handler
  - Calcular: progreso, spent, eficiencia, bugs por sprint
  - Implementar caché con Redis
  - _Requisitos: 6.2_

- [ ] 15.4 Implementar dashboard de métricas
  - Query: ObtenerDashboardQuery + Handler
  - Agregar métricas de todos los proyectos activos
  - Implementar caché con Redis
  - _Requisitos: 6.3_

- [ ] 15.5 Configurar subscriptions GraphQL para métricas
...
- [ ] 15.6 Crear resolvers GraphQL de métricas
  - Resolvers para queries de métricas
  - Resolvers para subscriptions
  - Aplicar GuardJWT
  - _Requisitos: 6.1, 6.2, 6.3_

- [ ] 15.7 Escribir property tests para métricas
