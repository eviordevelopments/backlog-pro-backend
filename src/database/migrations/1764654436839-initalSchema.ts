...
export class InitalSchema1764654436839 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'CREATE INDEX "IDX_091f9433895a53408cb8ae3864" ON "projects" ("clientId") ',
    );
    await queryRunner.query(
      'CREATE TABLE "sprints" ("id" uuid NOT NULL, "name" character varying(255) NOT NULL, "projectId" uuid NOT NULL, "goal" text, "startDate" date NOT NULL, "endDate" date NOT NULL, "status" character varying(50) NOT NULL DEFAULT \'planning\', "velocity" integer NOT NULL DEFAULT \'0\', "storyPointsCommitted" integer NOT NULL DEFAULT \'0\', "storyPointsCompleted" integer NOT NULL DEFAULT \'0\', "teamMembers" jsonb NOT NULL DEFAULT \'[]\', "sprintPlanningDate" TIMESTAMP, "sprintReviewDate" TIMESTAMP, "sprintRetrospectiveDate" TIMESTAMP, "dailyStandupTime" character varying(5) NOT NULL DEFAULT \'09:00\', "retrospectiveNotes" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_6800aa2e0f508561812c4b9afb4" PRIMARY KEY ("id"))',
    );
    await queryRunner.query(
      'CREATE TABLE "tasks" ("id" uuid NOT NULL, "title" character varying(255) NOT NULL, "description" text, "projectId" uuid NOT NULL, "sprintId" uuid, "status" character varying(50) NOT NULL DEFAULT \'todo\', "priority" character varying(50) NOT NULL DEFAULT \'medium\', "assignedTo" uuid, "estimatedHours" numeric(10,2) NOT NULL DEFAULT \'0\', "actualHours" numeric(10,2) NOT NULL DEFAULT \'0\', "storyPoints" integer NOT NULL DEFAULT \'0\', "dueDate" date, "tags" jsonb NOT NULL DEFAULT \'[]\', "dependencies" jsonb NOT NULL DEFAULT \'[]\', "subtasks" jsonb NOT NULL DEFAULT \'[]\', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_8d12ff38fcc62aaba2cab748772" PRIMARY KEY ("id"))',
    );
    await queryRunner.query(
      'CREATE TABLE "time_entries" ("id" uuid NOT NULL, "taskId" uuid NOT NULL, "userId" uuid NOT NULL, "hours" numeric(10,2) NOT NULL, "date" date NOT NULL, "description" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_b8bc5f10269ba2fe88708904aa0" PRIMARY KEY ("id"))',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE UNIQUE INDEX "IDX_326b2a901eb18ac24eabc9b058" ON "project_members" ("projectId", "userId") ',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE INDEX "IDX_d18be740055cddc6b157c36ea6" ON "meetings" ("status") ',
    );
    await queryRunner.query(
      'CREATE INDEX "IDX_430cc83b3f98820004cf2da874" ON "meetings" ("sprintId") ',
    );
    await queryRunner.query(
      'CREATE INDEX "IDX_945e04d31be6d4cc5934b4668f" ON "meetings" ("projectId") ',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE INDEX "IDX_aad02eec6766a51b7e9f1e782e" ON "goals" ("ownerId") ',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE INDEX "IDX_605be897e18635c785596cbaa9" ON "transactions" ("clientId") ',
    );
    await queryRunner.query(
      'CREATE INDEX "IDX_92d1d5070de965ff398a522b4f" ON "transactions" ("projectId") ',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE INDEX "IDX_20d900c6b7f2de7faa4d214d64" ON "invoices" ("projectId") ',
    );
    await queryRunner.query(
      'CREATE INDEX "IDX_d9df936180710f9968da7cf4a5" ON "invoices" ("clientId") ',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE INDEX "IDX_f5f44f663ee6bf25dcfab3987f" ON "feedback" ("sprintId") ',
    );
    await queryRunner.query(
      'CREATE INDEX "IDX_fefc350f416e262e904dcf6b35" ON "feedback" ("toUserId") ',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE TABLE "user_achievements" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "achievementId" uuid NOT NULL, "unlockedAt" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_3d94aba7e9ed55365f68b5e77fa" PRIMARY KEY ("id"))',
    );
    await queryRunner.query(
      'ALTER TABLE "sprints" ADD CONSTRAINT "FK_12a81f920cc034f4c532766bf18" FOREIGN KEY ("projectId") REFERENCES "projects"("id") ON DELETE CASCADE ON UPDATE NO ACTION',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE "tasks" ADD CONSTRAINT "FK_109de917495c10ad211df0b03e7" FOREIGN KEY ("sprintId") REFERENCES "sprints"("id") ON DELETE SET NULL ON UPDATE NO ACTION',
    );
    await queryRunner.query(
      'ALTER TABLE "time_entries" ADD CONSTRAINT "FK_8cfb57662e88d7c65010311661d" FOREIGN KEY ("taskId") REFERENCES "tasks"("id") ON DELETE CASCADE ON UPDATE NO ACTION',
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE "sprints" DROP CONSTRAINT "FK_12a81f920cc034f4c532766bf18"',
    );
