...
export class InitialSchemas1765807889986 implements MigrationInterface {
    name = 'InitialSchemas1765807889986'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying(255) NOT NULL, "passwordHash" character varying(255) NOT NULL, "name" character varying(255) NOT NULL, "avatar" character varying(500), "skills" jsonb, "hourlyRate" numeric(10,2), "isEmailVerified" boolean NOT NULL DEFAULT false, "emailConfirmationToken" character varying(255), "emailConfirmationExpiresAt" TIMESTAMP, "passwordResetToken" character varying(255), "passwordResetExpiresAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
